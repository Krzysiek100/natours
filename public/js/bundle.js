      ...
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          return fetch('http://127.0.0.1:3000/api/v1/users/login', {
            ...
            if (!res.ok) {
              throw new Error('Invalid email or password. probably error from server');
            }
            return res.json();
          });
        case 4:
          ...
          if (res.status === 'succes') {
            (0, _alerts.showAlert)('succes', 'Logged in successfully');
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 8:
          ...
          (0, _alerts.showAlert)('error', 'Try agains');
        case 12:
        case "end":
